...
$(document).ready(function($) {
    ...
    var submitReservation = $('#submit-reservation'),
        message = $('#msg-rsv');
    ...
    nav_container.waypoint({
        handler: function(direction) {
            if (direction == 'down') {
                ...
                nav.stop().addClass("active").css("top", -nav.outerHeight()).animate({
                    "top": top_spacing
                });
                ...
                nav.stop().removeClass("active").css("top", nav.outerHeight() + waypoint_offset).animate({
                    "top": ""
                });
